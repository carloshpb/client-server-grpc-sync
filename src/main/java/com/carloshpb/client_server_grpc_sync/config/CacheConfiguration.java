...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("client_server_grpc_sync");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("client_server_grpc_sync");
        ...
        config.getMapConfigs().put("com.carloshpb.client_server_grpc_sync.domain.*", initializeDomainMapConfig(jHipsterProperties));
